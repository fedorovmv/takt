...
func (s *Service) ListBlocks(profileName string) (*BlockCatalogView, error) {
...
func (s *Service) DescribeBlock(profileName, name string) (*blockcatalog.ResolvedBlock, error) {
