...
func auditedContracts() []auditedContract {
	return []auditedContract{
		...
		{Name: "Node", Type: reflect.TypeOf(spec.Node{}), DefaultSupport: "stable-candidate", DefaultDecision: "keep", Expected: []string{"id", "depends_on", "when", "trigger_rule", "provider", "context", "fresh_context", "cancel", "until_bash", "loop", "model", "executor", "command", "prompt", "bash", "script", "approval", "loop_group", "subworkflow", "foreach", "workflow", "attempts", "allow_failure", "always_run", "timeout", "idle_timeout", "hooks", "native_hooks", "allowed_tools", "denied_tools", "skills", "mcp", "sandbox", "requires", "tool_approval", "side_effect", "adapter", "output_format", "output_type", "output_mime", "output_path"}},
