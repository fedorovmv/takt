...
func auditedContracts() []auditedContract {
	return []auditedContract{
		...
		{Name: "LoopGroupSpec", Type: reflect.TypeOf(spec.LoopGroupSpec{}), DefaultSupport: "stable-candidate", DefaultDecision: "keep", Expected: []string{"max_iterations", "nodes", "until"}},
		{Name: "UntilSpec", Type: reflect.TypeOf(spec.UntilSpec{}), DefaultSupport: "stable-candidate", DefaultDecision: "keep", Expected: []string{"node", "exit_code", "output_contains"}},
