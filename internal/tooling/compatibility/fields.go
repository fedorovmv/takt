...
func auditedContracts() []auditedContract {
	return []auditedContract{
		...
		{Name: "Node", Type: reflect.TypeOf(spec.Node{}), DefaultSupport: "stable-candidate", DefaultDecision: "keep", Expected: []string{"id", "depends_on", "when", "trigger_rule", "provider", "context", "cancel", "loop", "model", "executor", "command", "prompt", "bash", "script", "approval", "loop_group", "subworkflow", "foreach", "matrix", "workflow", "assessment", "attempts", "allow_failure", "always_run", "timeout", "idle_timeout", "hooks", "native_hooks", "allowed_tools", "denied_tools", "skills", "mcp", "sandbox", "requires", "tool_approval", "side_effect", "adapter", "output_format", "output_type", "output_mime", "output_path"}},
		{Name: "Config", Type: reflect.TypeOf(spec.Config{}), DefaultSupport: "stable-candidate", DefaultDecision: "keep", Expected: []string{"apiVersion", "kind", "default_assistant", "model_preset", "models", "model_presets", "assistants", "adapters", "task_sources"}},
		{Name: "AssistantSpec", Type: reflect.TypeOf(spec.AssistantSpec{}), DefaultSupport: "supported-alpha", DefaultDecision: "defer", Expected: []string{"type", "argv", "binary", "args", "agent", "auto_approve", "session_dir", "project_trust", "settings", "env", "capabilities", "protocol", "max_output_bytes"}},
		...
		{Name: "WorkflowRunSpec", Type: reflect.TypeOf(spec.WorkflowRunSpec{}), DefaultSupport: "stable-candidate", DefaultDecision: "keep", Expected: []string{"path", "input", "output_node", "isolation", "repository", "keep_worktree", "policy", "fan_out"}},
		...
		{Name: "MatrixSpec", Type: reflect.TypeOf(spec.MatrixSpec{}), DefaultSupport: "stable-candidate", DefaultDecision: "keep", Expected: []string{"items_from", "as", "nodes", "output_node"}},
		{Name: "AssessmentSpec", Type: reflect.TypeOf(spec.AssessmentSpec{}), DefaultSupport: "stable-candidate", DefaultDecision: "keep", Expected: []string{"role", "target_run_id", "result_from", "scope", "evidence"}},
		...
		{Name: "ScriptSpec", Type: reflect.TypeOf(spec.ScriptSpec{}), DefaultSupport: "stable-candidate", DefaultDecision: "keep", Expected: []string{"runtime", "path", "inline", "args", "env", "stdin", "working_directory", "dependencies"}},
