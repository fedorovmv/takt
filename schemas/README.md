...
- `evaluation-input.schema.json` — materialized `takt-evaluation-input/v1alpha1` для одного ordinary evaluation Run: ordered cases/repeats, gates и fingerprints;
