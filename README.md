...
`v0.1.52-alpha` предназначена для **локального однопользовательского trusted runtime**. Workflow, config, Markdown-команды и рабочая директория считаются доверенными.
...
Архитектурные границы проверяет `scripts/test-architecture.sh`, входящий в release gate. Решение: [`docs/66-application-boundary-architecture-refactor-v0.1.52.md`](docs/66-application-boundary-architecture-refactor-v0.1.52.md), ADR-085.
