.PHONY: build test race vet fmt docs contracts pi-contracts route-e2e route-eval route-benchmark check demo
...
check: fmt vet test race build contracts pi-contracts route-e2e route-eval docs
