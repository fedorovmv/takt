...
route-strategy-benchmark-contract: build
	./scripts/test-route-dsl-benchmark.sh

task-evaluation-contract: build
...
iteration-history-contract: build
	./scripts/test-iteration-history.sh

compatibility-contract: build
