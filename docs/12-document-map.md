...
1. `docs/69-core-stabilization-modularization-v0.1.55.md`;
...
| Архитектурные и тестовые границы | `69-core-stabilization-modularization-v0.1.55.md`, `68-architecture-hardening-v0.1.54.md`, `67-go-native-test-architecture-v0.1.53.md`, `../tests/e2e/`, `../internal/architecture/` | stable dependency direction + modular experimental/extensions/tooling + Go-native contracts |
...
- Application boundary / architecture refactor: `docs/66-application-boundary-architecture-refactor-v0.1.52.md`, hardening `docs/68-architecture-hardening-v0.1.54.md`, modularization `docs/69-core-stabilization-modularization-v0.1.55.md`, `internal/application`, `internal/experimental`, `internal/extensions`, `internal/tooling`, `internal/bootstrap`, `internal/appapi`, `internal/architecture`, `go test ./internal/architecture`.
